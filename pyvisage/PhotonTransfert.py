...
class PhotonTransfert(Measurement.Measurement):
    ...
    def analyze_photontransfert(self,bFPN=False,bRTN=False,rtn_colstart=4,rtn_colstop=67,bsave=False,directory_suffix=None,bfullresolution=False,blog=False,bfit=True,fitrange='all',linewidth=1.0):
        ...
        PlotTools.plot_scatter(range(self.num_channel_groups),Read_noise,xlabel='Group',ylabel='Read Noise', yunit='DN',bsave=True,directory_save=self.directory_analysis)
        ...
        if (None not in slope_shot) or (None not in slope_shot_loglog):
            ...
            PlotTools.plot_scatter(range(self.num_channel_groups),slope_shot_loglog,xlabel='Group',ylabel='Slope shot LogLog', yunit=None,bsave=True,directory_save=self.directory_analysis)
            ...
            PlotTools.plot_scatter(range(self.num_channel_groups),conversion_gain,xlabel='Group',ylabel='Conversion Gain', yunit='e/DN',bsave=True,directory_save=self.directory_analysis)
