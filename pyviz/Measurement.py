...
class Measurement(object):
    ...
    def plot_vs_param(self,bfit=False,fitrange='all',linewidth=2.0, bfullnoise=False, rotation_xlabel=0):
        ...
        if bfit:
            ...
            print slope
            print gain
            PlotTools.plot_scatter(range(self.num_channel_groups),gain,xlabel='Column group',ylabel='Gain', yunit='uV/DN',bsave=True,directory_save=self.directory_analysis)
